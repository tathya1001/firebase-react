        ...
        <div className='container'>
            ...
            <Form onSubmit={handleSubmit}>
                ...
                <Form.Group controlId="crediterName">
                    ...
                    <Form.Control type="text" value={logName} onChange={(e) => setLogName(e.target.value)} />
                </Form.Group>

                <Form.Group controlId="categoryDropdown">
                    <Form.Label>Category:</Form.Label>
                    <Form.Control as="select" value={categoryId} onChange={(e) => setCategoryId(e.target.value)} className='text-black'>
                ...
                <Form.Group controlId="completedAmount">
                    ...
                    <Form.Control type="number" value={expense} onChange={(e) => setExpense(e.target.value)} />
                </Form.Group>
