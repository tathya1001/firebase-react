            ...
            <div className='container flex flex-col justify-center items-center font-[Rubik] ' onSubmit={handleSubmit}>
                ...
                <form className='max-w-[28rem] flex-col space-y-3'>
                    ...
                    <div className="relative">
                        <input type="text" id="floating_outlined1" className="block px-2.5 pb-2.5 pt-2.5 w-full text-md text-white bg-transparent rounded-lg border-2 border-slate-400 appearance-none focus:outline-none focus:ring-0 focus:border-blue-400 peer" placeholder=" " onChange={(e) => setCategoryName(e.target.value)} />

                        <label htmlFor="floating_outlined" className="absolute text-slate-300 bg-slate-900 text-md duration-300 transhtmlForm -translate-y-4 scale-75 top-2 z-10 origin-[0]  px-2 peer-focus:px-2 peer-focus:text-blue-400 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1">Category Name</label>
                    </div>

                    <div>
                        <label htmlFor="program-name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select Currency</label>

                        <div className="radio-tile-group flex flex-wrap justify-center items-center" onChange={(e) => setIconId(e.target.value)}>
                            ...
                            <div className="input-container h-12 w-12 m-2 relative">
                                <input id="walk" className="radio-button opacity-0 absolute top-0 left-0 h-full w-full cursor-pointer " type="radio" name="radio" value={2} />
                                <div className="radio-tile flex flex-col items-center justify-center w-full h-full rounded-full p-4 transition-transform ">
                            ...
                            <div className="input-container h-12 w-12 m-2 relative">
                                <input id="walk" className="radio-button opacity-0 absolute top-0 left-0 h-full w-full cursor-pointer " type="radio" name="radio" value={3} />
                                <div className="radio-tile flex flex-col items-center justify-center w-full h-full rounded-full p-4 transition-transform ">
                                    <div className='w-6 fill-black'>
                    ...
                    <div>
                        <label htmlFor="program-name2" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select Currency</label>

                        <div className="radio-tile-group flex flex-wrap justify-center items-center" onChange={(e) => setColorId(e.target.value)}>

                            <div className="input-container h-12 w-12 m-2 relative bg-[#FD2741] rounded-full">
                                <input id="walk2" className="color-button opacity-0 absolute top-0 left-0 h-full w-full cursor-pointer " type="radio" name="radio2" value={1} />
                                <div className="color-tile flex flex-col items-center justify-center w-full h-full rounded-full transition-transform">
                                </div>
                            </div>

                            <div className="input-container h-12 w-12 m-2 relative bg-[#458FFF] rounded-full">
                                <input id="walk" className="color-button opacity-0 absolute top-0 left-0 h-full w-full cursor-pointer " type="radio" name="radio2" value={2} />
                                <div className="color-tile flex flex-col items-center justify-center w-full h-full rounded-full transition-transform">
                                </div>
                            </div>

                            <div className="input-container h-12 w-12 m-2 relative bg-[#FFA800] rounded-full">
                                <input id="walk" className="color-button opacity-0 absolute top-0 left-0 h-full w-full cursor-pointer " type="radio" name="radio2" value={3} />
                                <div className="color-tile flex flex-col items-center justify-center w-full h-full rounded-full transition-transform">
                                </div>
                            </div>

                            <div className="input-container h-12 w-12 m-2 relative bg-[#48BB45] rounded-full">
                                <input id="walk" className="color-button opacity-0 absolute top-0 left-0 h-full w-full cursor-pointer " type="radio" name="radio2" value={4} />
                                <div className="color-tile flex flex-col items-center justify-center w-full h-full rounded-full transition-transform">
                                </div>
                            </div>

                            <div className="input-container h-12 w-12 m-2 relative bg-[#BC58EB] rounded-full">
                                <input id="walk" className="color-button opacity-0 absolute top-0 left-0 h-full w-full cursor-pointer " type="radio" name="radio2" value={5} />
                                <div className="color-tile flex flex-col items-center justify-center w-full h-full rounded-full transition-transform">
                                </div>
                            </div>

                            <div className="input-container h-12 w-12 m-2 relative bg-[#F460C2] rounded-full">
                                <input id="walk" className="color-button opacity-0 absolute top-0 left-0 h-full w-full cursor-pointer " type="radio" name="radio2" value={6} />
                                <div className="color-tile flex flex-col items-center justify-center w-full h-full rounded-full transition-transform">
                                </div>
                            </div>

                            <div className="input-container h-12 w-12 m-2 relative bg-[#FF810D] rounded-full">
                                <input id="walk" className="color-button opacity-0 absolute top-0 left-0 h-full w-full cursor-pointer " type="radio" name="radio2" value={7} />
                                <div className="color-tile flex flex-col items-center justify-center w-full h-full rounded-full transition-transform">
                                </div>
                            </div>
