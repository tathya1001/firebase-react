...
const HeroCard = (props) => {
    ...
    return (
        ...
        <div className="text-white w-[50%] min-w-36 sm:w-36 flex flex-col justify-between px-2.5 py-1.5 rounded-xl font-[Rubik] box-border " style={{ backgroundColor: bgColor }}>
