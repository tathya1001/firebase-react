...
const AddButton = () => {
    ...
    return (
        <div className="min-w-12 bg-transparent flex flex-col justify-center items-center px-3 py-3 rounded-[1rem] gap-2 font-[Rubik] box-border border-dashed border-black border-[0.20rem]">
