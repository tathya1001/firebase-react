...
const LogCard = (props) => {
    ...
    return (
        ...
        ((props.categoryid == 1) &&
            ...
            <div className="min-h-12 max-h-12 min-w-80 flex flex-row justify-between items-center px-3 py-1 rounded-[0.75rem] font-[Rubik] box-border text-white" style={{ backgroundColor: "grey" }}>
