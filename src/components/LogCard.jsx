...
const LogCard = (props) => {
    ...
    useEffect(() => {
        if (firebase.user) {
            const fetchCategoryData = async () => {
                ...
                const categoryData = await firebase.getCategoryData(firebase.user.uid, props.categoryid);
                if (categoryData) {
    ...
    return (
        ...
        ((props.categoryid == 1) &&
            ...
            <div className="min-h-12 max-h-12 max-w-80 flex flex-row justify-between items-center px-3 py-1 rounded-[0.75rem] font-[Rubik] box-border text-white" style={{ backgroundColor: "grey" }}>
                <div className="w-72 flex flex-row items-center gap-3">
                    <div className="w-8">
                        <svg className="fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M400 96l0 .7c-5.3-.4-10.6-.7-16-.7H256c-16.5 0-32.5 2.1-47.8 6c-.1-2-.2-4-.2-6c0-53 43-96 96-96s96 43 96 96zm-16 32c3.5 0 7 .1 10.4 .3c4.2 .3 8.4 .7 12.6 1.3C424.6 109.1 450.8 96 480 96h11.5c10.4 0 18 9.8 15.5 19.9l-13.8 55.2c15.8 14.8 28.7 32.8 37.5 52.9H544c17.7 0 32 14.3 32 32v96c0 17.7-14.3 32-32 32H512c-9.1 12.1-19.9 22.9-32 32v64c0 17.7-14.3 32-32 32H416c-17.7 0-32-14.3-32-32V448H256v32c0 17.7-14.3 32-32 32H192c-17.7 0-32-14.3-32-32V416c-34.9-26.2-58.7-66.3-63.2-112H68c-37.6 0-68-30.4-68-68s30.4-68 68-68h4c13.3 0 24 10.7 24 24s-10.7 24-24 24H68c-11 0-20 9-20 20s9 20 20 20H99.2c12.1-59.8 57.7-107.5 116.3-122.8c12.9-3.4 26.5-5.2 40.5-5.2H384zm64 136a24 24 0 1 0 -48 0 24 24 0 1 0 48 0z" /></svg>
                    </div>
                ...
                <div className="font-regular text-xl justify-self-end"><CurrencyComponent />{props.transaction}</div>
            </div>) ||

        ((props.categoryid != 1) &&

            <div className="min-h-16 max-h-16 max-w-80 flex flex-row justify-between items-center px-3 py-1 rounded-[0.75rem] font-[Rubik] box-border text-white" style={{ backgroundColor: colorCode }}>
                <div className="w-72 flex flex-row items-center gap-3">
                    <div className="w-8">
